...
export const techUnityK: TechDetails = {
  name: "Unity 3D",
...
export const techAndroidK: TechDetails = {
  name: "Android",
  about: [
...
export const techUMLK: TechDetails = {
  name: "UML 설계",
...
export const techNonDevK: TechDetails = {
  name: "개발 이외",
  about: [
    "MS Office 문서 작성 가능",
    "Photoshop 편집 가능",
...
export const techEtcK: TechDetails = {
  name: "기타",
  about: [
